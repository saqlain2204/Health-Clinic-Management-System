                ...
                with conn:
                    c.execute("""
                        ...
                        VALUES (
                            ...
                            :emergency_contact_name, :emergency_contact_relation, :emergency_contact_no, :email_id,
                            :reg_date, :reg_time
                        );
                    """, {
                        ...
                        'pin': self.pin_code, 'emergency_contact_name': self.next_of_kin_name,
                        'emergency_contact_relation': self.next_of_kin_relation_to_patient,
                        'emergency_contact_no': self.next_of_kin_contact_number,
